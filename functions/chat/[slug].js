...
function buildLivePageScript({ statusUrl, chatMessagesUrl, pollsActiveUrl, voteUrlBase, reportIssueUrl, accessMode, magicToken, isLectureSeule, isQaMode, isEnded, authorPlaceholder }) {
  return `<script>
(function () {
