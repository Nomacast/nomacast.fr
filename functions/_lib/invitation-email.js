...
// Helper consolidé : génère le contenu HTML + texte du mail d'invitation pour un event.
//
// Utilisé par TOUS les endpoints qui envoient des mails d'invitation (cf rapport infra §10.4) :
//   - functions/api/admin/events/[id]/send-invitations.js           (Nomacast envoi groupé)
//   - functions/api/admin/events/[id]/invitees/[invitee_id]/resend.js (Nomacast renvoi unitaire)
//   - functions/api/event-admin/[token]/send-invitations.js         (client envoi groupé)
//   - functions/api/event-admin/[token]/invitees/[invitee_id]/resend.js (client renvoi unitaire)
//
// Single source of truth pour : wording, description event (FR-3), CTAs, agenda links,
// design HTML, branding white-label, footer.
//
